...
const PROFILE_COLUMNS =
  "id, telegram_id, username, first_name, last_name, avatar_url, display_name, avatar_key, onboarded, is_premium, game_balance, boosts_balance, current_streak, longest_streak, last_active_date, created_at";
